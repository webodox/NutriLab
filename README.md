How to compile and run NutrLab:
    Prerequisites: Java JDK, Android SDK, Pixel 5 Device Emulator, or Android Studios
    Steps: 
1. Clone project repository from github here.
2. Open terminal and go to the project root directory.
3. Run ./gradlew assembleDebug (Mac) or ./gradlew.bat assembleDebug (Windows) to compile the project.
